...
namespace ZeusParkNew
{
    ...
    public partial class _default : System.Web.UI.Page
    {
        ...
        {
            WIDout_trade_no.Text = AlipayOrder.GetID();
            WIDsubject.Text = "测试订单";
            WIDtotal_fee.Text = "0.01";
        }
        ...
        protected void BtnAlipay_Click(object sender, EventArgs e)
        {
            ...
            //必填，不能修改
            //服务器异步通知页面路径
            string notify_url = "http://www.zeuspark.com//create_direct_pay_by_user-CSHARP-UTF-8/notify_url.aspx";
            //需http://格式的完整路径，不能加?id=123这类自定义参数

            //页面跳转同步通知页面路径
            string return_url = "http://www.zeuspark.com//create_direct_pay_by_user-CSHARP-UTF-8/return_url.aspx";
